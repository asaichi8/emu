...
{
	m_uiManager.RegisterWindow( std::make_shared<CodeListWindow>  ("Code list",  &m_pGameInfo, &m_pMD5pair, &m_dbMutex) );
	...
	m_uiManager.RegisterWindow( std::make_shared<AddCodeWindow>   ("Add code", &m_pGameInfo, &m_pMD5pair, &m_dbMutex) );
}
