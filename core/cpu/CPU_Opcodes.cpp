...
/* 1x */    i(BPL, REL, 2), i(ORA, IZY, 5), i(KIL, unk, 0), i(SLO, IZY, 8), i(NOP, ZPX, 4), i(ORA, ZPX, 4), i(ASL, ZPX, 6), i(SLO, ZPX, 6),   i(CLC, IMP, 2), i(ORA, ABY, 4), i(NOP, IMP, 2), i(SLO, ABY, 7), i(NOP, ABX, 4), i(ORA, ABX, 4), i(ASL, ABX, 7), i(SLO, ABX, 7), 
/* 2x */    i(JSR, ABS, 6), i(AND, IZX, 6), i(KIL, unk, 0), i(RLA, IZX, 8), i(BIT, ZPG, 3), i(AND, ZPG, 3), i(ROL, ZPG, 5), i(RLA, ZPG, 5),   i(PLP, IMP, 4), i(AND, IMM, 2), i(ROL, IMP, 2), i(ANC, IMM, 2), i(BIT, ABS, 4), i(AND, ABS, 4), i(ROL, ABS, 6), i(RLA, ABS, 6), 
/* 3x */    i(BMI, REL, 2), i(AND, IZY, 5), i(KIL, unk, 0), i(RLA, IZY, 8), i(NOP, ZPX, 4), i(AND, ZPX, 4), i(ROL, ZPX, 6), i(RLA, ZPX, 6),   i(SEC, IMP, 2), i(AND, ABY, 4), i(NOP, IMP, 2), i(RLA, ABY, 7), i(NOP, ABX, 4), i(AND, ABX, 4), i(ROL, ABX, 7), i(RLA, ABX, 7), 
/* 4x */    i(RTI, IMP, 6), i(EOR, IZX, 6), i(KIL, unk, 0), i(SRE, IZX, 8), i(NOP, ZPG, 3), i(EOR, ZPG, 3), i(LSR, ZPG, 5), i(SRE, ZPG, 5),   i(PHA, IMP, 3), i(EOR, IMM, 2), i(LSR, IMP, 2), i(ALR, IMM, 2), i(JMP, ABS, 3), i(EOR, ABS, 4), i(LSR, ABS, 6), i(SRE, ABS, 6), 
/* 5x */    i(BVC, REL, 2), i(EOR, IZY, 5), i(KIL, unk, 0), i(SRE, IZY, 8), i(NOP, ZPX, 4), i(EOR, ZPX, 4), i(LSR, ZPX, 6), i(SRE, ZPX, 6),   i(CLI, IMP, 2), i(EOR, ABY, 4), i(NOP, IMP, 2), i(SRE, ABY, 7), i(NOP, ABX, 4), i(EOR, ABX, 4), i(LSR, ABX, 7), i(SRE, ABX, 7), 
/* 6x */    i(RTS, IMP, 6), i(ADC, IZX, 6), i(KIL, unk, 0), i(RRA, IZX, 8), i(NOP, ZPG, 3), i(ADC, ZPG, 3), i(ROR, ZPG, 5), i(RRA, ZPG, 5),   i(PLA, IMP, 4), i(ADC, IMM, 2), i(ROR, IMP, 2), i(ARR, IMM, 2), i(JMP, IND, 5), i(ADC, ABS, 4), i(ROR, ABS, 6), i(RRA, ABS, 6), 
/* 7x */    i(BVS, REL, 2), i(ADC, IZY, 5), i(KIL, unk, 0), i(RRA, IZY, 8), i(NOP, ZPX, 4), i(ADC, ZPX, 4), i(ROR, ZPX, 6), i(RRA, ZPX, 6),   i(SEI, IMP, 2), i(ADC, ABY, 4), i(NOP, IMP, 2), i(RRA, ABY, 7), i(NOP, ABX, 4), i(ADC, ABX, 4), i(ROR, ABX, 7), i(RRA, ABX, 7), 
...
/* 9x */    i(BCC, REL, 2), i(STA, IZY, 6), i(KIL, unk, 0), i(AHX, IZY, 6), i(STY, ZPX, 4), i(STA, ZPX, 4), i(STX, ZPY, 4), i(SAX, ZPY, 4),   i(TYA, IMP, 2), i(STA, ABY, 5), i(TXS, IMP, 2), i(TAS, ABY, 5), i(SHY, ABX, 5), i(STA, ABX, 5), i(SHX, ABY, 5), i(AHX, ABY, 5), 
...
/* Bx */    i(BCS, REL, 2), i(LDA, IZY, 5), i(KIL, unk, 0), i(LAX, IZY, 5), i(LDY, ZPX, 4), i(LDA, ZPX, 4), i(LDX, ZPY, 4), i(LAX, ZPY, 4),   i(CLV, IMP, 2), i(LDA, ABY, 4), i(TSX, IMP, 2), i(LAS, ABY, 4), i(LDY, ABX, 4), i(LDA, ABX, 4), i(LDX, ABY, 4), i(LAX, ABY, 4), 
...
/* Dx */    i(BNE, REL, 2), i(CMP, IZY, 5), i(KIL, unk, 0), i(DCP, IZY, 8), i(NOP, ZPX, 4), i(CMP, ZPX, 4), i(DEC, ZPX, 6), i(DCP, ZPX, 6),   i(CLD, IMP, 2), i(CMP, ABY, 4), i(NOP, IMP, 2), i(DCP, ABY, 7), i(NOP, ABX, 4), i(CMP, ABX, 4), i(DEC, ABX, 7), i(DCP, ABX, 7), 
...
/* Fx */    i(BEQ, REL, 2), i(SBC, IZY, 5), i(KIL, unk, 0), i(ISC, IZY, 8), i(NOP, ZPX, 4), i(SBC, ZPX, 4), i(INC, ZPX, 6), i(ISC, ZPX, 6),   i(SED, IMP, 2), i(SBC, ABY, 4), i(NOP, IMP, 2), i(ISC, ABY, 7), i(NOP, ABX, 4), i(SBC, ABX, 4), i(INC, ABX, 7), i(ISC, ABX, 7)
